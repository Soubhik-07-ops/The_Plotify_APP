...
const MortgageCalculator = ({ visible, onClose, propertyPrice = 400000 }: MortgageCalculatorProps) => {
  ...
  const renderPaymentBreakdown = () => {
    ...
    return (
      <View className="mt-6">
        <Text className="text-lg font-playfair-bold text-black-300 mb-4">Payment Breakdown</Text>
  ...
  const renderAmortizationChart = () => {
    ...
    return (
      <View className="mt-6">
        <Text className="text-lg font-playfair-bold text-black-300 mb-4">Amortization Schedule</Text>
        <View className="bg-white rounded-xl p-4 shadow-sm">
          <LineChart
            data={chartData}
            width={width - 80}
  ...
  const renderAffordabilityTab = () => (
    <ScrollView className="flex-1 p-4">
      <View className="space-y-6">
        <View>
          <Text className="text-base font-playfair-medium text-black-300 mb-2">Annual Income</Text>
          <TextInput
            value={annualIncome}
        ...
        <View>
          <Text className="text-base font-playfair-medium text-black-300 mb-2">Monthly Debts</Text>
          <TextInput
            value={monthlyDebts}
