...
const EnhancedCalculator = ({ visible, onClose, propertyPrice = 400000 }: EnhancedCalculatorProps) => {
  ...
  const renderPaymentBreakdown = () => {
    ...
    return (
      <View className="mt-6">
          <Text style={{ fontSize: 18, fontWeight: 'bold', color: palette.textPrimary, marginBottom: 16 }}>Payment Breakdown</Text>
  ...
  const renderAmortizationChart = () => {
    ...
    return (
      <View className="mt-6">
          <Text style={{ fontSize: 18, fontWeight: 'bold', color: palette.textPrimary, marginBottom: 16 }}>Amortization Schedule</Text>
        <View style={{ backgroundColor: palette.surfaceMuted, borderRadius: 16, padding: 16, borderWidth: 1, borderColor: palette.border }}>
          <LineChart
            data={chartData}
            width={width - 80}
        ...
        <View style={{ 
          ...
          <View style={{ gap: 8 }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
              <Text style={{ color: palette.textSecondary }}>Principal & Interest</Text>
  ...
  const renderAffordabilityTab = () => (
    <ScrollView style={{ flex: 1, padding: 16, backgroundColor: palette.background }}>
      <View style={{ gap: 24 }}>
        <View>
          <Text style={{ fontSize: 16, fontWeight: '500', color: palette.textPrimary, marginBottom: 8 }}>Annual Income</Text>
          <TextInput
            value={annualIncome}
        ...
        <View>
          <Text style={{ fontSize: 16, fontWeight: '500', color: palette.textPrimary, marginBottom: 8 }}>Monthly Debts</Text>
          <TextInput
            value={monthlyDebts}
        ...
        <View style={{ 
          ...
          <View style={{ gap: 8 }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
              <Text style={{ color: palette.textSecondary }}>Monthly Income</Text>
    ...
    <ScrollView style={{ flex: 1, padding: 16, backgroundColor: palette.background }}>
      <View style={{ gap: 24 }}>
        <View style={{ 
          ...
          <Text style={{ color: palette.textPrimary, fontSize: 18, fontWeight: 'bold', marginBottom: 8 }}>First-Time Homebuyer Programs</Text>
          <Text style={{ color: palette.textSecondary, fontSize: 14 }}>Explore government assistance and special programs</Text>
        </View>

        <View className="space-y-4">
          <View style={{ backgroundColor: palette.surfaceMuted, borderRadius: 16, padding: 16, borderWidth: 1, borderColor: palette.border }}>
            <Text style={{ fontSize: 18, fontWeight: 'bold', color: palette.textPrimary, marginBottom: 8 }}>FHA Loans</Text>
            <Text style={{ color: palette.textSecondary, marginBottom: 8 }}>Federal Housing Administration loans with low down payment requirements</Text>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
              <Text style={{ color: palette.textMuted }}>Down Payment</Text>
              <Text style={{ fontWeight: 'bold', color: palette.primary }}>3.5%</Text>
            </View>
          </View>

          <View style={{ backgroundColor: palette.surfaceMuted, borderRadius: 16, padding: 16, borderWidth: 1, borderColor: palette.border, marginBottom: 12 }}>
            <Text style={{ fontSize: 18, fontWeight: 'bold', color: palette.textPrimary, marginBottom: 8 }}>VA Loans</Text>
            <Text style={{ color: palette.textSecondary, marginBottom: 8 }}>Veterans Affairs loans with no down payment required</Text>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
              <Text style={{ color: palette.textMuted }}>Down Payment</Text>
              <Text style={{ fontWeight: 'bold', color: palette.primary }}>0%</Text>
            </View>
          </View>

          <View style={{ backgroundColor: palette.surfaceMuted, borderRadius: 16, padding: 16, borderWidth: 1, borderColor: palette.border, marginBottom: 12 }}>
            <Text style={{ fontSize: 18, fontWeight: 'bold', color: palette.textPrimary, marginBottom: 8 }}>USDA Loans</Text>
            <Text style={{ color: palette.textSecondary, marginBottom: 8 }}>Rural development loans for eligible areas</Text>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
              <Text style={{ color: palette.textMuted }}>Down Payment</Text>
              <Text style={{ fontWeight: 'bold', color: palette.primary }}>0%</Text>
            </View>
        ...
        <View style={{ backgroundColor: palette.surfaceMuted, borderRadius: 16, padding: 16, borderWidth: 1, borderColor: palette.border }}>
          <Text style={{ fontSize: 18, fontWeight: 'bold', color: palette.textPrimary, marginBottom: 8 }}>Need Help?</Text>
          <Text style={{ color: palette.textSecondary, marginBottom: 12 }}>Contact our mortgage specialists for personalized assistance</Text>
          <TouchableOpacity style={{ backgroundColor: palette.primary, borderRadius: 12, paddingVertical: 12, paddingHorizontal: 24 }}>
            <Text style={{ color: '#0B0F17', fontWeight: 'bold', textAlign: 'center' }}>Contact Specialist</Text>
          </TouchableOpacity>
        </View>
      </View>
    </ScrollView>
      ...
      <SafeAreaView style={{ flex: 1, backgroundColor: palette.background }}>
        ...
        <View style={{ flexDirection: 'row', backgroundColor: palette.surface, borderBottomWidth: 1, borderBottomColor: palette.border }}>
          ...
          <TouchableOpacity
            ...
            style={{ flex: 1, paddingVertical: 12, paddingHorizontal: 16, borderBottomWidth: activeTab === 'assistance' ? 2 : 0, borderBottomColor: palette.primary }}
          >
            <Text style={{ textAlign: 'center', fontWeight: '500', color: activeTab === 'assistance' ? palette.primary : palette.textMuted }}>
              Assistance
            </Text>
          </TouchableOpacity>
        </View>
