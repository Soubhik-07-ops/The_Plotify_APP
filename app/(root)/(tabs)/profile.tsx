...
import { Body, BodyMuted, HeadingLarge, HeadingMedium } from "@/components/ui/Typography";
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: palette.background }}>
      ...
      >
        ...
        <View style={{ paddingHorizontal: 20, paddingTop: 12, marginBottom: 24 }}>
          <HeadingLarge>{t('profile.title')}</HeadingLarge>
        </View>
        ...
        <Card style={{
          ...
          <View style={{ alignItems: 'center' }}>
            ...
            <HeadingMedium style={{ marginBottom: 4 }}>
              {user?.name || 'User'}
            </HeadingMedium>
            ...
            >
              ...
              />
              <Body style={{ color: '#fff' }}>Logout</Body>
            </Button>
          </View>
        </Card>
        ...
        <View style={{ marginHorizontal: 20, marginBottom: 32 }}>
          ...
          <HeadingMedium style={{ marginBottom: 16 }}>
            {t('profile.settings')}
          </HeadingMedium>
          ...
          <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', padding: 20 }}>
            <View style={{
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
                <AppText style={{ fontSize: 24, fontWeight: 'bold', color: palette.textPrimary }}>
              ...
              {favoriteProperties.length === 0 ? (
                <View style={{ alignItems: 'center', paddingVertical: 40 }}>
                  <AppText style={{ fontSize: 24, marginBottom: 16 }} weight="semibold">Saved</AppText>
                  <AppText style={{
                    textAlign: 'center',
                ...
                <ScrollView showsVerticalScrollIndicator={false} style={{ maxHeight: '70%' }}>
                  {favoriteProperties.map((property) => (
                    ...
                    >
                      ...
                      />
                      <View style={{ flex: 1 }}>
                        <AppText style={{ fontWeight: 'bold', fontSize: 16, color: palette.textPrimary, marginBottom: 4 }}>
                          {property.name}
                        </AppText>
                        <AppText style={{ fontSize: 14, color: palette.textMuted, marginBottom: 4 }}>
                          {property.address}
                        </AppText>
                        <AppText style={{ color: palette.primary, fontWeight: 'bold', fontSize: 16 }}>
                      ...
                      <TouchableOpacity
                        ...
                        activeOpacity={0.8}
                      >
                        <AppText style={{ color: '#fff', fontSize: 14, fontWeight: 'bold' }}>{t('favorites.remove')}</AppText>
                      </TouchableOpacity>
                    </View>
                  ))}
                </ScrollView>
          ...
          <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', padding: 20 }}>
            <View style={{
              ...
              <View style={{ alignItems: 'center', marginBottom: 24 }}>
                ...
                <AppText style={{ marginTop: 12, fontSize: 14, color: palette.textMuted }}>
              ...
              <View style={{ flexDirection: 'row', gap: 12 }}>
                <TouchableOpacity
                  ...
                  activeOpacity={0.7}
                >
                  <AppText style={{ color: palette.textPrimary, fontWeight: '600', fontSize: 16 }}>{t('common.cancel')}</AppText>
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={handleSave}
                  disabled={loading}
                ...
                >
                  {loading ? (
                    ...
                    <AppText style={{ color: palette.surface, fontWeight: 'bold', fontSize: 16 }}>{t('common.save')}</AppText>
                  )}
                </TouchableOpacity>
              </View>
            </View>
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: palette.overlay }}>
          <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', padding: 20 }}>
            <View style={{
              ...
              <AppText style={{ color: palette.textSecondary, fontSize: 16, marginBottom: 20 }}>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.8}
              >
                <AppText style={{ color: palette.surface, fontWeight: 'bold', fontSize: 16 }}>{t('common.close')}</AppText>
              </TouchableOpacity>
            </View>
          </View>
        </SafeAreaView>
              ...
              <ScrollView showsVerticalScrollIndicator={false}>
                {languages.map((lang, idx) => (
                  ...
                  >
                    ...
                    {language === lang && (
                      <AppText style={{ fontSize: 14, color: palette.primary }} weight="semibold">Selected</AppText>
                    )}
                  </TouchableOpacity>
                ))}
              </ScrollView>
                ...
                {selectedHelp === null ? (
                  helpOptions.map((opt, idx) => (
                    <TouchableOpacity
                      ...
                      activeOpacity={0.7}
                    >
                      <AppText style={{ fontSize: 16, color: palette.primary, fontWeight: '500' }}>
                        {opt.question}
                      </AppText>
                    </TouchableOpacity>
                  ))
                  ...
                  <View>
                    <BackButton onPress={() => setSelectedHelp(null)} style={{ marginBottom: 16 }} color={palette.primary} />
                    <AppText style={{ fontSize: 18, fontWeight: 'bold', color: palette.textPrimary, marginBottom: 12 }}>
