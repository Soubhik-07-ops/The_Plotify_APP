    ...
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: palette.background }}>
        <View style={{ width: '85%', alignItems: 'center', justifyContent: 'center', flex: 1, alignSelf: 'center' }}>
          <Text style={{ color: palette.primary, fontSize: 28, fontWeight: '700', marginBottom: 16, textAlign: 'center', fontFamily: 'PlayfairDisplay-Bold' }}>Welcome to Plotify!</Text>
          <Text style={{ color: palette.textSecondary, fontSize: 16, marginBottom: 8, textAlign: 'center', fontFamily: 'PlayfairDisplay-Regular' }}>
            Your account has been created successfully.
          </Text>
          <Text style={{ color: palette.textSecondary, fontSize: 16, marginBottom: 32, textAlign: 'center', fontFamily: 'PlayfairDisplay-Regular' }}>
          ...
          >
            <Text style={{ color: palette.surface, fontSize: 18, fontWeight: '600', textAlign: 'center', fontFamily: 'PlayfairDisplay-SemiBold' }}>Let's Get Started</Text>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
    );
